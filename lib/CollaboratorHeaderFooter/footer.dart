...
class Collfooter extends StatefulWidget {
  const Collfooter({Key? key}) : super(key: key);

  @override
  State<Collfooter> createState() => _CollfooterState();
}

class _CollfooterState extends State<Collfooter> {
          ...
          Column(
            children: [
              ...
              Row(
                children: [
                  Container(
                    margin: EdgeInsets.fromLTRB(MediaQuery.of(context).size.width*0.125, 30, 0, 0),
                    height: 2.5,
